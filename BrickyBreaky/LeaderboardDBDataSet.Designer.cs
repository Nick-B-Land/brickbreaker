...
namespace BrickyBreaky {
    ...
    public partial class LeaderboardDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Name, string Message, int Score) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow FindByPlayerID(int PlayerID) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int PlayerID {
                get {
                    return ((int)(this[this.tableTable.PlayerIDColumn]));
                }
                set {
                    this[this.tableTable.PlayerIDColumn] = value;
                }
            }
...
namespace BrickyBreaky.LeaderboardDBDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([PlayerID] = @Original_PlayerID) AND ([Name] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Message], [Score]) VALUES (@Name, @Message, @" +
                "Score);\r\nSELECT PlayerID, Name, Message, Score FROM [Table] WHERE (PlayerID = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Message] = @Message, [Score] = @Score WHERE (([PlayerID] = @Original_PlayerID) AND ([Name] = @Original_Name) AND ([Score] = @Original_Score));
SELECT PlayerID, Name, Message, Score FROM [Table] WHERE (PlayerID = @PlayerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PlayerID, Name, Message, Score FROM dbo.[Table]";
